...
public class AES {
    public static PolynomialFunction irreduciblePolynomial = new PolynomialFunction(new double[]{1, 1, 0, 1, 1});
    public static int[][] SBox =
            {{0x63, 0x7c, 0x77, 0x7b, 0xf2, 0xf2, 0x6b, 0xc5, 0x30, 0x01, 0x67, 0x2b, 0xfe, 0xd7, 0xab, 0x76},
    ...
    private static Byte[][] mixColumnMatrix =
            {{new Byte(2), new Byte(3), new Byte(1), new Byte(1)},
    ...
    public Block mixColumns() {
        return null;
    }

    public Block mixColumn(Block block) {
